...
public class HBaseService {
    ...
    /*
     * 返回一个HbaseService Bean，供其它上层的服务调用。
     */
    public static HBaseService getInstance(){
        ApplicationContext context = new AnnotationConfigApplicationContext(HBaseConfig.class);
        return context.getBean(HBaseService.class);
    }
